...
export const offline = (() => {
    ...
    const setOffline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-ban me-2"></i>No Internet';
    };
    ...
    const setOnline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-cloud me-2"></i>"Network Restore"';
    };
